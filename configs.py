...
celebahq_cfg1 = dict(dataset_type='CelebAHQ',
                     ...
                     vqvae_path='vqvae/model_celebahq_1.pth',
                     gen_model_path='vqvae/gen_model_celebahq_1.pth')
...
celebahq_cfg2 = dict(dataset_type='CelebAHQ',
                     ...
                     pixelcnn_dim=384,
                     pixelcnn_linear_dim=256,
                     vqvae_path='vqvae/model_celebahq_2.pth',
                     gen_model_path='vqvae/gen_model_celebahq_2.pth')
...
celebahq_cfg3 = dict(dataset_type='CelebAHQ',
                     ...
                     pixelcnn_dim=384,
                     pixelcnn_linear_dim=256,
                     vqvae_path='vqvae/model_celebahq_3.pth',
                     gen_model_path='vqvae/gen_model_celebahq_3.pth')
...
celebahq_cfg4 = dict(dataset_type='CelebAHQ',
                     ...
                     pixelcnn_dim=384,
                     pixelcnn_linear_dim=256,
                     vqvae_path='vqvae/model_celebahq_4.pth',
                     gen_model_path='vqvae/gen_model_celebahq_4.pth')
